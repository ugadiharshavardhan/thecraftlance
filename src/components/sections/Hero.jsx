    ...
    >
      <div className="relative z-10 flex-1 flex flex-col justify-center w-full max-w-7xl mx-auto px-6 md:px-10 pt-28 md:pt-32 pb-16">
        <div className="max-w-3xl">
          ...
          >
            <a href="#" aria-label="X" className="text-white hover:opacity-55 transition-opacity">
            ...
            <a href="#" aria-label="Instagram" className="text-white hover:opacity-55 transition-opacity">
          ...
          <motion.h1
            ...
            className="font-bold text-white uppercase tracking-[-0.04em] leading-[0.92] text-[clamp(2.6rem,7.5vw,5.75rem)] mb-6"
          >
            The Craft
            <br />
            Lance
          ...
          <motion.p
            ...
            className="text-zinc-400 text-sm md:text-base leading-relaxed max-w-md mb-8"
          >
        ...
        <motion.div
          ...
          className="mt-16 md:mt-20 flex flex-col sm:flex-row sm:items-center gap-6 sm:gap-10 border-t border-white/10 pt-8"
        >
