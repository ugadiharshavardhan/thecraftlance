...
const StrokeText = ({
  ...
  }, [box, dash, drawDuration, fillDelay, stagger, ease, trigger, fillMode, reverse, onAnimationComplete]);
  ...
  return (
    <span
      ...
      style={{ ...style, '--stroke-text-height': `${box ? Math.round(box.height) : Math.round(fontSize * 1.3)}px` }}
      role="img"
